...
ggplot(tab1, aes(x= factor(ClusterID), y=Mean_amount,fill = factor(ClusterID))) + geom_bar(stat = "identity")
ggplot(tab1, aes(x= factor(ClusterID), y=Mean_freq,fill = factor(ClusterID))) + geom_bar(stat = "identity")
ggplot(tab1, aes(x= factor(ClusterID), y=Mean_recency,fill = factor(ClusterID))) + geom_bar(stat = "identity")
...
rect.hclust(RFM_hclust2, h=1, border="red")
