...
# 3. Many of the variables are poorly named, my apo,logies.
...
levels(train$C_previous) <- c("1", "2", "3", "4", "none")
...
getwd()
train <- read.csv("Allstate_test.csv",sep=",",colClasses=colClasses)
